...
void Factory::initSpriteFrame() {
	...
	auto monsterDeadAnimation = Animation::createWithSpriteFrames(monsterDead, 0.1f);
	AnimationCache::getInstance()->addAnimation(monsterDeadAnimation, "monsterDeadAnimation");
}
